...
<body background="images/aprendiz.jpg" style="background-attachment: fixed" >
	...
	<table border="0" align="center" valign="middle">
		<tr>
		<td rowspan=2>
		<form action="validaraprendiz.php" method="post">

		<table border="0">

		<tr><td><label style="font-size: 14pt "><b>ID: </b></label></td>
...
<br>
<center><input type="button" onclick=" location.href='index.php' " value="REGRESAR" name="boton" /></center>
